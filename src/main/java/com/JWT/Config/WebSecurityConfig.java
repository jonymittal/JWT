...
import com.JWT.Security.JwtAuthorizationTokenFilter;
import com.JWT.Security.JwtTokenUtil;
import com.JWT.ServiceImpl.UserService;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity httpSecurity) throws Exception {
		httpSecurity.csrf().disable().exceptionHandling().authenticationEntryPoint(unauthorizedHandler).and()
				...
				.antMatchers(HttpMethod.POST, "/v1/api/userSignup", "/v1/api/userLogin", "/v1/api/user/{userId}/resetPassword")
	...
	public void configure(WebSecurity web) throws Exception {
		web.ignoring().antMatchers(HttpMethod.POST, authenticationPath).and().ignoring()
				.antMatchers(HttpMethod.GET, "/", "/*.html", "/favicon.ico", "/**/*.html", "/**/*.jsp", "/**/*.css",
						"/**/*.js", "/**/*.png", "/**/*.jpg", "/**/*.jpeg", "/**/*.JPG", "/**/*.gif", "/**/*.map",
						"/fonts/**", "/js/**", "css/**", "/frontend/app/static/**")
